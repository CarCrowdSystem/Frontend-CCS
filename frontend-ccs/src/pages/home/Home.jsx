        ...
        <>
            <header>
                <div className='container'>
                    ...
                    <div className='espacoBotaoHeader'>
                        <a href='/cadastro'><BotaoContratar>Contratar</BotaoContratar></a>
                    </div>
                </div>
            </header>
            ...
            <div className='aboutUs'>
                <div className='container'>
                    ...
                    <div className='tituloAoutUs'><h1>O que é a Car Crowd System?</h1></div>
                ...
                <div className='separaFooter'>
                    ...
                    <div className='bloco'>
                        <div className='imgBloco'>
                            <img src='imgs/Group 39.png' style={{ width: 100, height: 100 }} />
                        </div>
                        <p>Copyright© Car Crowd System</p>
                    </div>

                    <div className='bloco' style={{ display: 'flex', flexDirection: '-moz-initial', justifyContent: 'center' }}>
                        <div className='imgBloco'>
                            <img src='/imgs/icons/Group 8.png' style={{ width: 200, height: 50 }} />
                        </div>
                    </div>
                </div>
            </footer>
