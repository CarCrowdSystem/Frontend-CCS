...
export function validateEmail(email) {
    ...
    if(!(email.length >= 8 && email.indexOf("@") !== -1 && email.endsWith(".com"))){
...
export function returnStatus(status, nomeV) {
    ...
    switch(nomeV){
        case "nomeEmpresa": statusNome = status;
        break;
        case "cnpj": statusCnpj = status;
        break;
        case "cep": statusCep = status;
        break;
        case "num": statusNum = status;
        break;
        case "telefone": statusTelefone = status;
        break;
        case "vagas": statusVaga = status;
        break;
        case "nomeUsuario": statusNomeU = status;
        break;
        case "cpf": statusCpf = status;
        break;
        case "email": statusEmail = status;
        break;
        case "senha": statusSenha = status;
        break;
        default: console.log("sei lá"); break;
    }
}